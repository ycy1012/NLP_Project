from datasets import load_dataset, Value   # <-- add Value
...
# 7. Load DistilBERT with a single-output regression head
...
# 8. Define regression metrics: MSE, MAE, and rounded accuracy on validation
...
# 14. Round continuous predictions to the nearest integer in [0, 4]
label_ids = [0, 1, 2, 3, 4]
...
# Save the figure
plt.savefig("confusion_matrix_distilbert_reg.png", dpi=300)
plt.close()